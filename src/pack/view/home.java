...
public class home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(190, 10, 480, 60);
        ...
        txtadmin.setBounds(10, 40, 140, 30);
        ...
        jPanel2.add(txtnama);
        txtnama.setBounds(410, 30, 300, 30);

        jLabel4.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jLabel4.setText("Harga Barang");
        jPanel2.add(jLabel4);
        jLabel4.setBounds(10, 120, 160, 20);
        jPanel2.add(txtharga);
        txtharga.setBounds(10, 150, 300, 30);
        ...
        cbKategoriBrg.setBounds(10, 90, 300, 30);

        cbjenis.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pack", "Grosir", "Eceran" }));
        ...
        jPanel2.add(cbjenis);
        cbjenis.setBounds(410, 90, 300, 30);
        ...
        jPanel2.add(txtkode);
        txtkode.setBounds(10, 30, 300, 30);
        ...
        jPanel2.add(jLabel9);
        jLabel9.setBounds(410, 0, 100, 20);

        jLabel10.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jLabel10.setText("Kategori Barang");
        jPanel2.add(jLabel10);
        jLabel10.setBounds(10, 60, 210, 20);

        jLabel11.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jLabel11.setText("Jenis Packing");
        jPanel2.add(jLabel11);
        jLabel11.setBounds(410, 60, 160, 20);

        getContentPane().add(jPanel2);
        jPanel2.setBounds(0, 90, 770, 190);
        ...
        Btn_Hapus.setForeground(new java.awt.Color(102, 102, 102));
        ...
        Btn_Simpan.setForeground(new java.awt.Color(102, 102, 102));
        ...
        Btn_Ubah.setForeground(new java.awt.Color(102, 102, 102));
        ...
        Btn_Bersih.setForeground(new java.awt.Color(102, 102, 102));
        ...
        jScrollPane1.setBounds(60, 150, 610, 180);

        jLabel12.setFont(new java.awt.Font("RBNo2 Light Alternative ", 0, 18)); // NOI18N
        jLabel12.setText("Cari Berdasarkan Kategori");
        jPanel3.add(jLabel12);
        jLabel12.setBounds(270, 70, 180, 30);
        ...
        jButton2.setFont(new java.awt.Font("Minion Pro", 1, 14)); // NOI18N
        ...
        Btn_Keluar.setBounds(620, 350, 110, 30);

        getContentPane().add(jPanel3);
        jPanel3.setBounds(0, 280, 770, 410);

        setSize(new java.awt.Dimension(783, 725));
